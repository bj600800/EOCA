...
public class generate_new_sequence {
	...
	public static void main(String[] args) throws Exception{
		BufferedReader br = new BufferedReader(new FileReader(new File("D:\\demo\\results\\forpredict\\5matrix_PH_alp_"+matrix_size+".csv")));
